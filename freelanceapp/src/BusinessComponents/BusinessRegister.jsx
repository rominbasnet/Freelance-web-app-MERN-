import '../Components/FreelancerRegister.css';
import axios from 'axios';
import {useEffect, useRef, useState} from 'react';
import {useNavigate} from 'react-router-dom';
import {useDispatch, useSelector} from 'react-redux';
import {businessRegister} from '../actions/businessAuthAction';
...
const BusinessRegister = () => {
  ...
  useEffect(() => { 
    setValidName(USER_REGEX.test(companyName))
     }, [companyName])
          ...
          <div className="formbg">
            <div className="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" onSubmit={handleSubmit}>
                ...
                <select id="country" name="country" value={location} onChange={(e)=>setLocation(e.target.value)}>
